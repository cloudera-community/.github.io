...
const config = {
  title: 'Cloudera ❤️ Open Source',
  tagline: 'Power of opensource in data',
  ...
  projectName: 'cloudera-community.github.io',
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        copyright: `Copyright © ${new Date().getFullYear()} Cloudera.`,
      },
      prism: {
